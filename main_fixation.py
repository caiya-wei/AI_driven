...
s1 = [la, 1., 1., 1.]
s2 = [la, 0., 0., 0.]
benefit_to_cost_ratios = [2, 3, 3.5, 4, 4.5, 5]
...
results = results.reshape(len(benefit_to_cost_ratios), 1)

inde = ['b/c=2', 'b/c=3', 'b/c=3.5', 'b/c=4', 'b/c=4.5', 'b/c=5']
colu = ['RR']
results_df = pd.DataFrame(results, index=inde, columns=colu)

results_df.to_excel('pho_100(4).xlsx')
